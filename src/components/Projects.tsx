  ...
  return <section id="projects" className="py-24 relative">
      ...
      <div className="section-container relative z-10">
        ...
        <div className="space-y-8">
          {projects.map((project, index) => <div key={project.title} className="project-card">
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tags.map(tag => <span key={tag} className="skill-tag text-xs">
                          {tag}
                        </span>)}
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {project.achievements.map(achievement => <div key={achievement.label} className="flex items-center gap-3 p-3 rounded-xl bg-secondary/50">
